...
if __name__ == '__main__':
    ...
    model = load_model('models/model_p04j01_simple_lstm_argparse_N256_R0.0001_.99.hdf5')
    ...
    submission_filename = 'submissions/p04s02_simple_lstm_N256_R0p0001_20171120_1.csv'
