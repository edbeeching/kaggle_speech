...
def train_model(input_shape=(249,64,1), reg=0.0, drop=0.0, weight=False, max_epoch=50):
    ...
    tensor_board = TensorBoard(log_dir='tensorboard/08j01/model_p08j01_simple_conv_model_REG{}_DROP{}_W{}'.format(reg, drop, weight))
    check_point = ModelCheckpoint(filepath='models/08j01/model_p08j01_simple_conv_model_REG{}_DROP{}_W{}'.format(reg, drop, weight)+'.{epoch:02d}.hdf5', period=10)
